(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  ...
  {
    2941: function (e, t, s) {
      Promise.resolve().then(s.bind(s, 412));
    },
    6669: function (e, t, s) {
      "use strict";
      s.d(t, {
      ...
      var i = s(6691),
        l = s.n(i);
      function a(e) {
        let {data: t, setter: s, active: i, column: a, className: o, small: c} = e;
        (0, r.useEffect)(() => {
          let e = setInterval(() => {
            s((e) => (e + 1) % t.length);
          }, 2e5);
              ...
              : t.map((e, s) =>
                  (0, n.jsxs)(
                    "button",
                    {
                      ...
                      children: [e.icon && (0, n.jsx)(l(), {src: e.icon, width: 28, height: 28, alt: "icon"}), e.title],
                    },
                    s,
                  ),
                ),
    ...
    1169: function (e, t, s) {
      ...
      function i(e) {
        ...
        return (0, n.jsxs)("article", {
          ...
          children: [
            (0, n.jsxs)("div", {
              ...
              children: [
                ...
                (0, n.jsxs)("svg", {
                  ...
                  children: [
                    (0, n.jsx)("circle", {cx: "16", cy: "16", r: "16", fill: i ? "#F8F8F8" : "#AB3534"}),
                    (0, n.jsx)("path", {
                      fillRule: "evenodd",
                      clipRule: "evenodd",
            ...
            (0, n.jsx)("div", {
              className: " font-text transition-all duration-300 text-h-grey px-6 max-h-0 opacity-0 ".concat(i && "opacity-100 !max-h-[1200px]"),
              children: s,
            }),
          ],
        });
      ...
      function l(e) {
        ...
        return (0, n.jsx)("div", {
          ...
          children: (null == t ? void 0 : t.length) && t.map((e, t) => (0, n.jsx)(i, {question: e.question, answer: e.answer}, t)),
        });
      }
    },
    9837: function (e, t, s) {
      ...
      var r = s(4983);
      function i(e) {
        let {routes: t, black: s, className: i} = e;
        return (0, n.jsx)("div", {className: i, children: (0, n.jsx)(r.Z, {className: s ? "" : "white-bread", separator: ">", items: t})});
      }
      function l(e) {
        let {title: t, routes: s, img_url: r, className: l} = e;
        return (0, n.jsxs)("section", {
          className: " relative text-white bg-cover bg-center bg-no-repeat " + l,
          style: r ? {backgroundImage: "url(".concat(r, ")")} : {},
          children: [
            (0, n.jsxs)("div", {
              className: " max-w-c-full m-auto h-[362px] p-6 lg:px-8 lg:h-40 flex flex-col justify-center relative z-10 sshort:h-fit",
              children: [
                (0, n.jsx)("h1", {className: " ss:text-lg sm:text-[25px] lg:text-2xl font-title font-bold text-3xl mb-5", children: t}),
                (0, n.jsx)(i, {routes: s}),
              ],
            }),
            (0, n.jsx)("div", {className: "absolute top-0 left-0 w-[100%] h-[100%] bg-[#202020] opacity-50"}),
          ],
        });
      }
      s(1729);
          ...
          children: (0, n.jsxs)("div", {
            ...
            children: [
              (0, n.jsx)("div", {
                ...
                children: (0, n.jsx)(i(), {className: "h-[100%] w-[100%]", fill: !0, src: "/services/3@32.png", alt: ""}),
              }),
              (0, n.jsx)("div", {
                className: "h-[77px] w-[219px] relative",
                children: (0, n.jsx)(i(), {className: "h-[100%] w-[100%]", fill: !0, src: "/services/4@32.png", alt: ""}),
              }),
              (0, n.jsx)("div", {
                className: "h-[77px] w-[219px] relative",
                children: (0, n.jsx)(i(), {className: "h-[100%] w-[100%]", fill: !0, src: "/services/5@32.png", alt: ""}),
              }),
              (0, n.jsx)("div", {
                className: "h-[85px] w-[173px] relative",
                children: (0, n.jsx)(i(), {className: "h-[100%] w-[100%]", fill: !0, src: "/services/6@32.png", alt: ""}),
              }),
            ],
          }),
        });
        ...
        return (0, n.jsxs)(n.Fragment, {
          children: [
            (0, n.jsx)(i.Z, {
              ...
              routes: [
                {title: "Главная", href: "/"},
                {title: "Часто задаваемые вопросы", href: "questions"},
              ],
              className:
            ...
            (0, n.jsx)("section", {
              children: (0, n.jsxs)("div", {
                className: "max-w-c-full mt-[120px] lg:mt-0 mb-6 lg:mb-0 mx-auto p-6 lg:px-8",
                children: [
                  (0, n.jsx)("h2", {
                  ...
                  (0, n.jsx)(l.Z, {active: e, setter: t, data: c, className: ""}),
                ],
              }),
            }),
            (0, n.jsx)("section", {
              className: "mb-[160px] lg:mb-0",
              children: (0, n.jsx)("div", {className: "max-w-c-full mb-6 mx-auto p-6 lg:px-8", children: (0, n.jsx)(a.Z, {items: c[e].items})}),
            }),
            (0, n.jsx)(o.Z, {}),
          ],
        });
    ...
    622: function (e, t, s) {
      ...
      function c(e, t, s) {
        var n,
          ...
          c = null,
          u = null;
        for (n in (void 0 !== s && (c = "" + s), void 0 !== t.key && (c = "" + t.key), void 0 !== t.ref && (u = t.ref), t))
          l.call(t, n) && !o.hasOwnProperty(n) && (i[n] = t[n]);
        if (e && e.defaultProps) for (n in (t = e.defaultProps)) void 0 === i[n] && (i[n] = t[n]);
        return {$$typeof: r, type: e, key: c, ref: u, props: i, _owner: a.current};
      }
