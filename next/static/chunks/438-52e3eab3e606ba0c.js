  ...
  [438],
  {
    ...
    5250: function (e, t, r) {
      ...
      function g(e, t, r, n, o, u) {
        if (u || (0, i.isLocalURL)(t)) {
          if (!n.bypassPrefetchedCheck) {
            let o = t + "%" + r + "%" + (void 0 !== n.locale ? n.locale : "locale" in e ? e.locale : void 0);
            if (m.has(o)) return;
            m.add(o);
          }
          Promise.resolve(u ? e.prefetch(t, o) : e.prefetch(t, r, n)).catch((e) => {});
        }
      }
      function y(e) {
      ...
      let b = n.default.forwardRef(function (e, t) {
        ...
        ((r = _), N && ("string" == typeof r || "number" == typeof r) && (r = n.default.createElement("a", null, r)));
        let C = n.default.useContext(s.RouterContext),
          k = n.default.useContext(c.AppRouterContext),
          I = null != C ? C : k,
          L = !C,
          T = !1 !== v,
          U = null === v ? h.PrefetchKind.AUTO : h.PrefetchKind.FULL,
          {href: A, as: W} = n.default.useMemo(() => {
            if (!C) {
              let e = y(m);
          ...
          D = n.default.useRef(A),
          z = n.default.useRef(W);
        N && (u = n.default.Children.only(r));
        let K = N ? u && "object" == typeof u && u.ref : t,
          [F, $, q] = (0, f.useIntersection)({rootMargin: "200px"}),
          B = n.default.useCallback(
            (e) => {
              ((z.current !== W || D.current !== A) && (q(), (z.current = W), (D.current = A)),
                F(e),
        ...
        n.default.useEffect(() => {
          I && $ && T && g(I, A, W, {locale: E}, {kind: U}, L);
        }, [W, A, $, E, T, null == C ? void 0 : C.locale, I, L, U]);
        let Y = {
          ref: B,
          onClick(e) {
            (N || "function" != typeof S || S(e),
              N && u.props && "function" == typeof u.props.onClick && u.props.onClick(e),
              I &&
                !e.defaultPrevented &&
                (function (e, t, r, o, u, a, l, s, c) {
                  ...
                  let d = () => {
                    let e = null == l || l;
                    "beforePopState" in t
                      ? t[u ? "replace" : "push"](r, o, {shallow: a, locale: s, scroll: e})
                      : t[u ? "replace" : "push"](o || r, {scroll: e});
                  };
          ...
          onMouseEnter(e) {
            (N || "function" != typeof w || w(e),
              N && u.props && "function" == typeof u.props.onMouseEnter && u.props.onMouseEnter(e),
              I && (T || !L) && g(I, A, W, {locale: E, priority: !0, bypassPrefetchedCheck: !0}, {kind: U}, L));
          },
          onTouchStart(e) {
            (N || "function" != typeof x || x(e),
              N && u.props && "function" == typeof u.props.onTouchStart && u.props.onTouchStart(e),
              I && (T || !L) && g(I, A, W, {locale: E, priority: !0, bypassPrefetchedCheck: !0}, {kind: U}, L));
          },
        };
        if ((0, a.isAbsoluteUrl)(W)) Y.href = W;
        else if (!N || P || ("a" === u.type && !("href" in u.props))) {
          let e = void 0 !== E ? E : null == C ? void 0 : C.locale,
            t =
              (null == C ? void 0 : C.isLocaleDomain) &&
              (0, d.getDomainLocale)(W, e, null == C ? void 0 : C.locales, null == C ? void 0 : C.domainLocales);
          Y.href = t || (0, p.addBasePath)((0, l.addLocale)(W, e, null == C ? void 0 : C.defaultLocale));
        }
        return N ? n.default.cloneElement(u, Y) : n.default.createElement("a", {...M, ...Y}, r);
      });
      ("function" == typeof t.default || ("object" == typeof t.default && null !== t.default)) &&
        void 0 === t.default.__esModule &&
        (Object.defineProperty(t.default, "__esModule", {value: !0}), Object.assign(t.default, t), (e.exports = t.default));
        ...
        try {
          ...
          if ((0, s.isDynamicRoute)(e.pathname) && e.searchParams && r) {
            let r = (0, n.searchParamsToUrlQuery)(e.searchParams),
              {result: u, params: a} = (0, c.interpolateAs)(e.pathname, e.pathname, r);
            u && (t = (0, o.formatWithValidation)({pathname: u, hash: e.hash, query: (0, i.omit)(r, a)}));
          }
    ...
    1030: function (e, t, r) {
      ...
      function i(e) {
        ...
        return (
          i && !i.endsWith(":") && (i += ":"),
          e.slashes || ((!i || o.test(i)) && !1 !== s) ? ((s = "//" + (s || "")), u && "/" !== u[0] && (u = "/" + u)) : s || (s = ""),
          a && "#" !== a[0] && (a = "#" + a),
          c && "?" !== c[0] && (c = "?" + c),
          "" + i + s + (u = u.replace(/[?#]/g, encodeURIComponent)) + (c = c.replace("#", "%23")) + a
        );
      }
          ...
          parameterizedRoute: t
            .map((e) => {
              let t = n.INTERCEPTION_ROUTE_MARKERS.find((t) => e.startsWith(t)),
                i = e.match(/\[((?:\[.*\])|.+)\]/);
              if (t && i) {
                let {key: e, optional: n, repeat: l} = u(i[1]);
                return ((r[e] = {pos: a++, repeat: l, optional: n}), "/" + (0, o.escapeStringRegexp)(t) + "([^/]+?)");
              }
              if (!i) return "/" + (0, o.escapeStringRegexp)(e);
              {
                let {key: e, repeat: t, optional: n} = u(i[1]);
                return ((r[e] = {pos: a++, repeat: t, optional: n}), t ? (n ? "(?:/(.+?))?" : "/(.+?)") : "/([^/]+?)");
              }
            })
            .join(""),
          groups: r,
        ...
        return {
          namedParameterizedRoute: u
            .map((e) => {
              ...
              if (r && i) {
                let [r] = e.split(i[0]);
                return s({getSafeRouteKey: a, interceptionMarker: r, segment: i[1], routeKeys: l, keyPrefix: t ? "nxtI" : void 0});
              }
              return i ? s({getSafeRouteKey: a, segment: i[1], routeKeys: l, keyPrefix: t ? "nxtP" : void 0}) : "/" + (0, o.escapeStringRegexp)(e);
            })
            .join(""),
          routeKeys: l,
        };
        ...
        _insert(e, t, n) {
          ...
          if (o.startsWith("[") && o.endsWith("]")) {
            let r = o.slice(1, -1),
              u = !1;
            if (
              (r.startsWith("[") && r.endsWith("]") && ((r = r.slice(1, -1)), (u = !0)),
    ...
    622: function (e, t, r) {
      ...
      function s(e, t, r) {
        var n,
          ...
          s = null,
          c = null;
        for (n in (void 0 !== r && (s = "" + r), void 0 !== t.key && (s = "" + t.key), void 0 !== t.ref && (c = t.ref), t))
          u.call(t, n) && !l.hasOwnProperty(n) && (i[n] = t[n]);
