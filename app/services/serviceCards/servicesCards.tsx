  ...
  return (
    <section className=" relative">
        <div className="max-w-c-full m-auto relative z-20 px-6 py-16 lg:px-10">
            ...
            <div className="grid grid-cols-[repeat(auto-fit,_minmax(390px,_1fr))] gap-x-[30px] gap-y-[40px] pb-[120px]">
                <ServiceCard title='Автомобильные перевозки' img_url='/services/cargo-truck-on-the-mountain-truck-on-road-cargo-2021-08-26-16-36-15-utc 1.png' route_url='/services/railway' />
                <ServiceCard title='Автомобильные перевозки' img_url='/services/cargo-truck-on-the-mountain-truck-on-road-cargo-2021-08-26-16-36-15-utc 1.png' route_url='/services/railway' />
                <ServiceCard title='Автомобильные перевозки' img_url='/services/cargo-truck-on-the-mountain-truck-on-road-cargo-2021-08-26-16-36-15-utc 1.png' route_url='/services/railway' />
                <ServiceCard title='Автомобильные перевозки' img_url='/services/cargo-truck-on-the-mountain-truck-on-road-cargo-2021-08-26-16-36-15-utc 1.png' route_url='/services/railway' />
                <ServiceCard title='Автомобильные перевозки' img_url='/services/cargo-truck-on-the-mountain-truck-on-road-cargo-2021-08-26-16-36-15-utc 1.png' route_url='/services/railway' />
