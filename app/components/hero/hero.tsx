...
export default function Hero() {
  return (
    <section className="w-full relative">
        <div className="max-w-c-full m-auto h-[calc(100vh-68px)] flex flex-col justify-center z-10 relative">
          ...
          <div className="mt-[28px] font-title font-bold text-3xl max-w-[729px]">
        ...
        <div className=" absolute top-0 left-0 h-full w-full">
          <Image src='/main-banner.png' fill={true} alt="Main Banner" objectFit="cover" />
        </div>
        <div className=" absolute top-0 left-0 h-full w-full bg-[linear-gradient(90deg,rgba(0,0,0,1)-20%,rgba(255,255,255,0)80%)] opacity-70"></div>
    </section>
  )
}
