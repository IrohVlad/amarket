        ...
        <h3 className="font-bold text-[28px] mt-[80px] text-black ss:text-lg">
                ...
                <div className="mt-[60px] text-black">
                    <div className="flex mb-[40px]">
                        <div className="mr-4"><Image width={36} height={36} src="/services/count.svg" alt="Our doings"/></div>
                        <div>
                    ...
                    <div className="flex mb-[40px]">
                        <div className="mr-4"><Image width={36} height={36} src="/services/depression.svg" alt="Our doings"/></div>
                        <div>
                    ...
                    <div className="flex mb-[40px]">
                        <div className="mr-4"><Image width={36} height={36} src="/services/time.svg" alt="Our doings"/></div>
                        <div>
                    ...
                    <div className="flex mb-[40px]">
                        <div className="mr-4"><Image width={36} height={36} src="/services/effect.svg" alt="Our doings"/></div>
                        <div>
