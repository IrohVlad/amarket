    ...
    return (
        <header className="bg-white sticky z-50 top-0 left-0 text-black">
            <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 h-16 lg:px-8" aria-label="Global">
                ...
                <Popover.Group className="flex lg:hidden gap-x-12 text-sm text-h-grey font-semibold leading-6">
                    <Link href="/"
                    ...
                    <Popover className="relative">
                        <Popover.Button
                            className={`link ${pathname === '/market' ? 'text-black' : ''} hover:text-black flex items-center gap-x-1`}>
                            Логистика
                    ...
                    <Popover className="relative text-sm font-semibold leading-6">
                        <Popover.Button
                            className={`link ${pathname === '/market' ? 'text-black' : ''} hover:text-black flex items-center gap-x-1`}>
                            Информация
                            <ChevronDownIcon className="h-5 w-5 flex-none text-gray-400" aria-hidden="true"/>
