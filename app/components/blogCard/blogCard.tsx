  ...
  return (
    <div className=''>
                    <div className='w-[410px] h-[410px] relative'>
                        <Image src={img_url} alt='Blog Card' fill={true} objectPosition='center' objectFit='cover' className='h-full w-full' />
                    </div>
                    <div className='mt-[25px] font-title text-[18px] text-[#6C6C6C] font-semibold flex items-center justify-between'>
                        <div className='flex items-center'>
                            <svg className='h-[28px] w-[28px] mr-3' width="29" height="28" viewBox="0 0 29 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className='mt-5 text-[black] font-title text-[28px] font-bold'>
                        {title}
                    </div>
                    <div className='mt-4 font-text text-[#6C6C6C]'>
                        {description}
                    </div>
                    <div className='text-[20px] font-semibold text-[black] border-b-[1px] leading-[90%] w-fit mt-5 hover:text-red cursor-pointer transition-colors duration-100'>
                        Читать далее
                    </div>
                </div>
  )
