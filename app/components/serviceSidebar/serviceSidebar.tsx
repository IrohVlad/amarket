...
export default function ServiceSidebar() {
  ...
  return (
    <div className=" sticky top-20 border-r border-[#00000020] mb-8 lg:border-r-0 lg:border-b ">
                ...
                <div className="px-[29px] max-w-[306px] lg:max-w-none lg:flex lg:items-center lg:gap-10 md:flex-col md:items-start">
                    <div className=" text-[28px] font-bold mb-5 text-black">Нужна <br/> помощь?</div>
                    <Button className='px-5 py-[15px] rounded-none h-fit ss:px-2 ss:py-2'><div className="text-white font-bold text-[18px] w-fit flex items-center"> <div className="mr-[10px]"><Image height={16} width={16} className='min-w-4 min-h-4' src="/call.svg" alt=""/></div> <div>Связаться с нами</div></div></Button>
                </div>
    </div>
  )
}